...
export class Card {
   ...
   */
  public static compareRank(a: Card, b: Card): number {
    if (a.rank < b.rank) {
      return -1;
   ...
   */
  public static compareSuit(a: Card, b: Card): number {
    if (a.suit < b.suit) {
      return -1;
   ...
   */
  constructor(x: number | string | {rank: number | string, suit?: number | string},
              y?: number | string) {
